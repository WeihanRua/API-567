...
def Github(*args):
    ...
    if not args:
        ...
        userID = args[0]
    try:
        website_respond_repo = urllib.request.urlopen(f'https://api.github.com/users/{userID}/repos').read().decode()
        ...
        for i in js_dict:        
            ...
            website_respond_commit = urllib.request.urlopen(f'https://api.github.com/repos/{userID}/{repo}/commits').read().decode()
